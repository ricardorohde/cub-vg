...
<? include_once('_header.php'); ?>
            ...
            <div id="breadcrumbs">
            	<ul>
                	<li><span><em>Escritório</em></span></li>
                </ul>
            </div><!-- END breadcrumbs -->
            ...
            <div class="parentFull institucional">
                ...
                <div class="modulo idiomasSite listagem">
                	<div class="head">
                    	<div class="boxBotoes" style="display:none">
                            <a href="<? echo $endereco_site; ?>/ack/institucional/incluir" class="botao add" title="Adicionar  Escritório"><span><var></var><em>Adicionar  Escritório</em></span><var class="borda"></var></a>
                            <button class="botao excluir" title="Excluir"><span><var></var><em>Excluir</em></span><var class="borda"></var></button>
                        </div><!-- END boxBotoes -->
                        
                    	<button class="btnAB"><em>Escritórios da seção</em></button>
						<?
                            $modelTextos=new ACKtextos_Model();
                    	...
                    	<div class="lista topicoSecao" id="topicos">
                            <div class="header">
                                ...
                                <div>
                                    ...
                                    <div class="titulo ordem"><button><em>Escritório</em></button></div>
