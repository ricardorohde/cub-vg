                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            $moduloVerificaEscritorio=$modelSite->idModulo("institucional");
                            ...
                            <? } ?>
							<? if ($modelUser->userLevel($moduloVerificaEscritorio, false)) { ?>
                                <li><a href="<? echo $endereco_site; ?>/ack/institucional" title="escritorio">Escritório</a></li>
                            <? } ?>
							<? if ($modelUser->userLevel($moduloVerificaProdutos, false) or $modelUser->userLevel($moduloVerificaProdutosCat, false)) { ?>
                                <li>
                                    <a href="javascript:void(0);" class="subsub" title="Produtos">Projetos</a>
                                    <ul>
                                        <li class="topo"></li>
							...
							<? if ($modelUser->userLevel($moduloVerificaContatos, false) or $modelUser->userLevel($moduloVerificaSetores, false) or $modelUser->userLevel($moduloVerificaNewsletter, false)) { ?>
                                <li>
                                    <a href="<? echo $endereco_site; ?>/ack/contatos"  title="Contatos">Contatos</a>
                                </li>
                            <? } ?>
                            <li class="fundo"></li>
                        </ul>
