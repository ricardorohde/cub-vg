...
<? include_once('_header.php'); ?> 
            ...
            <div id="breadcrumbs">
            	<a href="<? echo $endereco_site; ?>/ack/produtos/categorias" class="btnSeta voltarTopo" title="Voltar">Voltar</a>
            	<ul>
                	<li><a href="<? echo $endereco_site; ?>/ack/produtos" title="Institucional"><em>Produtos</em></a></li>
                	<li><a href="<? echo $endereco_site; ?>/ack/produtos/categorias" title="Institucional"><em>Categorias de produtos</em></a></li>
                    <li><span><em><? if ($tipoAcao=="incluir") { ?>Adicionar<? } ?><? if ($tipoAcao=="editar") { ?>Editar<? } ?> categoria</em></span></li>
                </ul>
            </div><!-- END breadcrumbs -->
            ...
            <div id="descricaoPagina">
            	<h2><? if ($tipoAcao=="incluir") { ?>Adicionar<? } ?><? if ($tipoAcao=="editar") { ?>Editar<? } ?> categoria</h2>
				<?
                ...
                <div class="modulo" id="categorias">
                    ...
                    <div class="slide colunas">
                    	<div class="collumA form">
                            ...
                            <fieldset>
                                <legend><em>Título da categoria </em><strong>[<? echo $conteudoIdiomas[0]["nome"]; ?> - <? echo strtoupper($conteudoIdiomas[0]["abreviatura"]); ?>]</strong></legend>
                            ...
                            <fieldset style="display:none" class="editorTexto textarea683x110 ">
                                ...
                                <textarea id="editor" <? if ($nivelPermissao["nivel"]=="2") { ?>name="descricao_<? echo $conteudoIdiomas[0]["abreviatura"]; ?>"<? } ?> rows="5" cols="50"><? echo $dadosCategoria["descricao_".$conteudoIdiomas[0]["abreviatura"]]; ?></textarea>
                            </fieldset>
                        </div><!-- END collumA -->
                        ...
                        <div class="collumB">
                            <fieldset class="radioGrup checkVisivel">
                            	...
                            	<label><input type="radio" <?php if ($nivelPermissao["nivel"]=="2") { ?>name="visivel"<?php } else { ?>disabled="disabled"<?php } ?> value="1"<? if ($dadosCategoria["visivel"]=="1" or !$dadosCategoria) { ?> checked="checked"<? } ?> /><span>Sim</span></label>
                            	<label><input type="radio" <?php if ($nivelPermissao["nivel"]=="2") { ?>name="visivel"<?php } else { ?>disabled="disabled"<?php } ?> value="0"<? if ($dadosCategoria["visivel"]=="0") { ?> checked="checked"<? } ?> /><span>Não</span></label>
