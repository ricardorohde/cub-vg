...
<? include_once('_header.php'); ?>
            ...
            <div id="breadcrumbs">
            	<ul>
                	<li><span><em>Projetos</em></span></li>
                </ul>
            </div><!-- END breadcrumbs -->
            ...
            <div class="parentFull produtos" id="produtos">
                ...
                <div class="modulo listagem">
                	<div class="head">
                    	<div class="boxBotoes">
                            <a href="<? echo $endereco_site; ?>/ack/produtos/incluir" class="botao add" title="Adicionar projeto"><span><var></var><em>Adicionar projeto</em></span><var class="borda"></var></a>
                            <button class="botao excluir" title="Excluir produto"><span><var></var><em>Excluir</em></span><var class="borda"></var></button>
                        </div><!-- END boxBotoes -->
                        
                    	<button><em>Lista de projetos</em></button>
                        <?
							$modelTextos=new ACKtextos_Model();
							echo $modelTextos->carregaTexto("58");
						?>
                            ...
                            <div class="lista list_produtos">
                                <div class="header">
                                    ...
                                    <div>
                                        ...
                                        <div class="nomeProduto ordem"><button><em>Nome do projeto</em></button></div>
